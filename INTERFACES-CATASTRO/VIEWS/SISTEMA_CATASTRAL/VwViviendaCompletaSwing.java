package VIEWS.SISTEMA_CATASTRAL;
...
public class VwViviendaCompletaSwing extends JPanel {
    ...
    public VwViviendaCompletaSwing(JPanel contenedorPadre, String claveRetorno) {
        ...
        JButton btnVolver = new JButton("← Volver al Menú Catastral");
        ...
        pnlBuscar.add(new JLabel("Buscar: "));
        ...
        tabla.setRowSorter(sorter); // Asignamos el clasificador/filtrador a la tabla
    ...
    private void cargarDatos() {
        // Limpiar el modelo por si se recarga la vista
        modelo.setRowCount(0);
        modelo.setColumnCount(0);

        String url = "jdbc:postgresql://localhost:5432/catastro_municipal";
        String sql = "SELECT * FROM public.vw_vivienda_completa"; 
