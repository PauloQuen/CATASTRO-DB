...
public class VwPredioDetalladoSwing extends JPanel {
    ...
    public VwPredioDetalladoSwing(JPanel contenedorPadre, String claveRetorno) {
    ...
    private void cargarDatos() {
        ...
        String sql = "SELECT * FROM public.vw_predio_detallado"; 
