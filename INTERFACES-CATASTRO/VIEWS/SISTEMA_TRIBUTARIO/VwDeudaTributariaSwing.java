...
public class VwDeudaTributariaSwing extends JPanel {
    ...
    public VwDeudaTributariaSwing(JPanel contenedorPadre, String claveRetorno) {
        ...
        pnlBuscar.add(new JLabel("Buscar Contribuyente/Estado: "));
    ...
    private void cargarDatos() {
        ...
        String sql = "SELECT * FROM public.vw_deuda_tributaria"; 
        ...
        try (Connection conn = DriverManager.getConnection(url, "postgres", "pauloq3408");
            ...
            JOptionPane.showMessageDialog(this, "Error al cargar deudas tributarias: " + ex.getMessage());
        }
    }
}