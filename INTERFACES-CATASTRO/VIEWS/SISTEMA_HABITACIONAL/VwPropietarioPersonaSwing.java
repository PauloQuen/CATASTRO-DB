...
public class VwPropietarioPersonaSwing extends JPanel {
    ...
    public VwPropietarioPersonaSwing(JPanel contenedorPadre, String claveRetorno) {
    ...
    private void cargarDatos() {
        ...
        String sql = "SELECT * FROM public.vw_propietario_persona"; 
