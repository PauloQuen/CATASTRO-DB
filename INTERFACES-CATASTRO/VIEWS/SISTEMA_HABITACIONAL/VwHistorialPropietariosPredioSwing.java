package VIEWS.SISTEMA_HABITACIONAL;
...
public class VwHistorialPropietariosPredioSwing extends JPanel {
    ...
    public VwHistorialPropietariosPredioSwing(JPanel contenedorPadre, String claveRetorno) {
        ...
        JButton btnVolver = new JButton("← Volver al Menú Habitacional");
        ...
        pnlBuscar.add(new JLabel("Buscar por Predio o Dueño: "));
    ...
    private void cargarDatos() {
        ...
        String sql = "SELECT * FROM public.vw_historial_propietarios_predio"; 
        ...
        try (Connection conn = DriverManager.getConnection(url, "postgres", "pauloq3408");
            ...
            JOptionPane.showMessageDialog(this, "Error al cargar historial de propietarios: " + ex.getMessage());
        }
    }
}